...
$(document).ready(function(e){
    $('.copyright').html('©2022 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By Carl.Zhang');
})
​
$(document).ready(function(e){
    show_date_time();
...
$('.framework-info').html('这破网站已经安全运行<span id="span_dt_dt" style="color: #fff;"></span>');
